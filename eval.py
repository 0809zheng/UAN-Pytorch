...
parser.add_argument('--test_dataset', type=str, default='Set5/X4')
parser.add_argument('--model_type', type=str, default='UAN')
parser.add_argument('--residual', type=bool, default=False)
parser.add_argument('--model', default='weights/UANx4.pth', help='sr pretrained base model')
...
test_set = get_test_set(opt.input_dir, opt.test_dataset, opt.upscale_factor)
...
def save_img(img, img_name):
    save_img = img.squeeze().clamp(0, 1).numpy().transpose(1,2,0)*255
    # save img
    ...
    im = Image.fromarray(save_img.astype('uint8')).convert('RGB')
#    im.show()
    im.save(save_fn)
